-- https://github.com/Kong/lua-resty-counter/blob/master/lib/resty/counter.lua
...
function _M:expire(key, time_in_secs)
  return self.dict:expire(key, time_in_secs)
end
...
function _M:flush_expired()
  return self.dict:flush_expired()
end
